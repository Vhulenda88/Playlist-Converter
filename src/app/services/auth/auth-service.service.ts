  ...
  login(platform: string){
    switch (platform) {
      ...
      case Platforms.YOUTUBE:
        ...
        window.location.href = `${Youtube.Login}?client_id=${Youtube.ClientID}&redirect_uri=${encodeURI(Youtube.RedirectUri)}&response_type=code&scope=${Youtube.Scope[0]}%20${Youtube.Scope[1]}%20${Youtube.Scope[2]}%20${Youtube.Scope[3]}`;
        break;
